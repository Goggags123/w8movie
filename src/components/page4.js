...
export default class Page4 extends Component {
    ...
    return(
        <div className="page4">
            <div className={this.props.seat=="Normal"?"selected":""} onClick={()=>this.props.kept("seat","Normal")}>
                <img className="seat" src={normal}/>
                <img className="seatSelected" src={normalSelected}/>
                <p>Normal Seat</p>
                <div/>
            </div>
            <div className={this.props.seat=="Honeymoon"?"selected":""} onClick={()=>this.props.kept("seat","Honeymoon")}>
